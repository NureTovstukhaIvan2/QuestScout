...
const AdminDashboard = () => {
  ...
  const roomPopularityData = rooms
    .map((room) => {
  ...
  const bookingStatusData = [
    ...
    {
      name: "Cancelled",
      value: bookings.filter((b) => b.payment_status === "cancelled").length,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-slate-100 p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-zinc-900 p-6 rounded-lg shadow-lg">
          <h3 className="text-xl font-semibold mb-4">Most Popular Rooms</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={roomPopularityData}>
                ...
                />
                <Legend />
                <Bar dataKey="bookings" name="Bookings" fill="#F97316" />
                <Bar dataKey="revenue" name="Revenue (UAH)" fill="#10B981" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Create, edit and delete escape rooms
              </p>
            </div>
