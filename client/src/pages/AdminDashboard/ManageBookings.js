...
const ManageBookings = () => {
  ...
  const handleUpdateBooking = async (bookingId) => {
    try {
      ...
      refetch();
      showSnack("Booking updated successfully!");
    } catch (err) {
      console.error("Failed to update booking:", err);
      showSnack("Failed to update booking. Please try again.");
    }
  };
  ...
  const handleDeleteBooking = async (bookingId) => {
    try {
      ...
      refetch();
      showSnack("Booking deleted successfully!");
    } catch (err) {
      console.error("Failed to delete booking:", err);
      showSnack("Failed to delete booking. Please try again.");
    }
  };
