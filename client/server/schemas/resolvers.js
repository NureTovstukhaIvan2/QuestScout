...
const resolvers = {
  Query: {
    ...
    availableSlots: async (
      ...
      if (!escapeRoom) {
        throw new UserInputError("Quest room not found");
      }
  ...
  Mutation: {
    ...
    updateName: async (parent, { input }, context) => {
      ...
      try {
        ...
        throw new ApolloError("Failed to update name. Please try again.");
      }
    },
    ...
    createEscapeRoom: async (parent, { input }, context) => {
      ...
      try {
        ...
        console.error("Error creating quest room:", error);
        throw new ApolloError("Failed to create quest room. Please try again.");
      }
    },
    ...
    updateEscapeRoom: async (parent, { id, input }, context) => {
      ...
      try {
        ...
        console.error("Error updating quest room:", error);
        throw new ApolloError("Failed to update quest room. Please try again.");
      }
    },
    ...
    deleteEscapeRoom: async (parent, { id }, context) => {
      ...
      try {
        ...
        console.error("Error deleting quest room:", error);
        throw new ApolloError("Failed to delete quest room. Please try again.");
      }
    },
  },
